...
public class Frutas extends Entity {
    ...
    public void update(float delta) {
        super.update(delta); // CORREÇÃO: Atualiza os bounds do motor do jogo
    }
    ...
    public void draw(ShapeRenderer _renderer) {
        switch(type) {
            ...
            case UVA -> {
                ...
                _renderer.circle(position.x + tamanho/4, position.y + tamanho/2, tamanho/4);
                _renderer.circle(position.x + 3*tamanho/4, position.y + tamanho/2, tamanho/4);
                _renderer.circle(position.x + tamanho/2, position.y + tamanho/4, tamanho/4);
            }
        }
    }
